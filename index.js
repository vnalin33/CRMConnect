...
// Wrapped in try-catch to prevent native module init failures from crashing the app.
try {
  ...
  console.warn('[FCM] Failed to set up background message handler:', err.message);
}
